...
class My_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.first_Sage.setGeometry(QtCore.QRect(90, 70, 150, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.check_Sage.setText(_translate('MainWindow','课程',None))
    ...
    def buttonTest(self):
        ...
        if self.check_Sage.isChecked():
            if is_first:
                is_first = False
                temp_sqlstring += "classname= '{}'".format(self.first_Sage.text())
            else:
                temp_sqlstring += "classname ='{}' ".format(self.first_Sage.text())
...
class MyWindow( QMainWindow,My_MainWindow):
